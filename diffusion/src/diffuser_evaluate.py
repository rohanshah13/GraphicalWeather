...
class Diffusion:
    ...
    def prepare(self, args):
        ...
        self.load(f"models/{config.run_name}")

    def generate(self, args):
        self.log_images(self.test_dataloader, save=True)
...
def parse_args(config):
    ...
    parser.add_argument('--lead_time', type=int, default=120, help='Forecast lead time')
...
if __name__ == '__main__':
    ...
    with wandb.init(project="test", group="train", config=config):
        ...
        diffuser.evaluate(diffuser.test_dataloader)